...
public class ConfirmFragment extends Fragment {
    ...
    private void var(){
        ...
        //      Adapter
        adapter = new OrderAdapter(getContext(),0);
        manageOrderAdapter = new ManageOrderAdapter(getContext(),0);
    }
    //#Launcher UI
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.e(ConfirmFragment.class.getSimpleName(),sharedPreferences.getBoolean("ACCOUNT_TYPE",false)+"");
