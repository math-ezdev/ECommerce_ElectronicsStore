...
public class SuccessFragment extends Fragment {
    ...
    private void var(){
        ...
        //      Adapter
        adapter = new OrderAdapter(getContext(),10);
        manageOrderAdapter = new ManageOrderAdapter(getContext(),10);
    }
    //#Launcher UI
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.e(SuccessFragment.class.getSimpleName(),sharedPreferences.getBoolean("ACCOUNT_TYPE",false)+"");
