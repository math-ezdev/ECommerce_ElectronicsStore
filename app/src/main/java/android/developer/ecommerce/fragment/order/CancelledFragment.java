...
public class CancelledFragment extends Fragment {
    ...
    private void var(){
        ...
        //      Adapter
        adapter = new OrderAdapter(getContext(),99);
        manageOrderAdapter = new ManageOrderAdapter(getContext(),99);
    }
    //#Launcher UI
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.e(CancelledFragment.class.getSimpleName(),sharedPreferences.getBoolean("ACCOUNT_TYPE",false)+"");
